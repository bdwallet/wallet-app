      ...
      <div class="container conitem first">
        <transition name="fade-left">
          <div v-show="section.first" class="textbox">
            ...
            <!-- 查看白皮书 -->
            <div class="btns">
              <div class="btn wap-show" @click="Download">下载APP</div>
              <div class="btn" v-if="0" @click="Viewbook">查看白皮书</div>
            </div>
          </div>
        </transition>
      ...
      <div class="container conitem second">
        <transition name="fade-left">
          <div v-show="section.second" class="textbox">
            ...
            <p class="cn">去中心化评级</p>
            <p class="desc">公正、权威、有影响力</p>
            <p class="desc">让你听到市场的真实回声</p>
          </div>
        </transition>
        <transition name="fade-right">
      ...
      <div class="container conitem third align-right">
        ...
        <transition name="fade-right">
          <div v-show="section.third" class="textbox">
            ...
            <p class="cn">区块链金融服务</p>
            <p class="desc">多元化的数字资产投资组合</p>
            <p class="desc">灵活投资，收益稳定</p>
          </div>
        </transition>
      </div>
    </div>
      ...
      <div class="container conitem fourth">
        <transition name="fade-left">
          <div v-show="section.fourth" class="textbox">
            ...
            <p class="cn">安全易用的区块链钱包</p>
            <p class="desc">为您的数字资产保驾护航</p>
            <p class="desc">随时随地收款与支付</p>
          </div>
        </transition>
        <transition name="fade-right">
      ...
      <div class="container conitem ratings-list">
        <transition name="fade-top">
          <div v-show="section.fifth" class="section-title">
            ...
            <div class="title-box">
              <p class="cn">项目评级</p>
              <router-link tag="div" to="ratings" class="more">查看更多</router-link>
            </div>
          </div>
        </transition>
        <transition name="fade-bottom">
          <ul v-if="section.fifth" class="ratings-list-box">
            <li v-for="item in itemData" :key="item" @click="gotoDetail(item.item_id)">
              <circle-progress class="score" :value="item.item_grade"></circle-progress>
              <div class="info">
                <img :src="item.item_logo" />
                <div class="name">
                  <h1>{{item.item_en_name}}{{item.item_en_name&&item.item_cn_name?'/':''}}{{item.item_cn_name}}</h1>
