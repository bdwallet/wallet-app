<template>
  <div class="scroll" :class="{
    ...
    <div class="scroll-inner" :style="{
      ...
      <div class="pull-to-refresh-layer" v-if="needscroll && !!onRefresh">
        <slot name="refresh">
...
<script>
  export default {
    ...
    methods: {
      ...
      touchMove(e) {
        if (this.getBodyScrollTop() > 0 || !this.touching || !this.needscroll) {
          return
        }
      ...
      onScroll(e) {
        ...
        let infiniteHeight = 10;//this.$el.querySelector('.infinite-layer').clientHeight
